<?php
// source: /domains1/test_sedlacek_php_7_4_cz/public/config/common.neon
// source: /domains1/test_sedlacek_php_7_4_cz/public/config/local.neon
// source: array
...
class Container_c6f274060e extends Nette\DI\Container
{
	...
	protected $wiring = [
		...
		'App\Presenters\CronPresenter' => [2 => ['application.1']],
	...
	public function createService02(): App\Model\Restaurant
	{
		return new App\Model\Restaurant($this->getService('database.default.context'));
	}


	public function createServiceApplication__1(): App\Presenters\CronPresenter
	{
		$service = new App\Presenters\CronPresenter($this->getService('02'));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/domains1/test_sedlacek_php_7_4_cz/public/temp/cache');
	}


	public function createServiceContainer(): Container_c6f274060e
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=idc_test', 'idc_test', 'y2t7NpF5cKVUbuhX', []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_c6f274060e $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/domains1/test_sedlacek_php_7_4_cz/public/temp/cache/latte');
