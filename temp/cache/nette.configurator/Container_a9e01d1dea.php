<?php
// source: D:\wamp64\idc/config/common.neon
// source: D:\wamp64\idc/config/local.neon
// source: array
...
class Container_a9e01d1dea extends Nette\DI\Container
{
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'D:\wamp64\idc/temp/cache/nette.application/touch'));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\wamp64\idc/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('D:\wamp64\idc/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_a9e01d1dea
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_a9e01d1dea $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\wamp64\idc/temp/cache/latte');
